...
<div class="alynt-404-settings-section">
	<h2><?php esc_html_e( 'Color Settings', 'alynt-404-sitemap' ); ?></h2>
	<p class="description">
		<?php esc_html_e( 'Customize colors for both 404 and sitemap pages. These colors will override theme defaults.', 'alynt-404-sitemap' ); ?>
	</p>
			...
			<tr>
				<th scope="row">
					<label for="headings_color">
						<?php esc_html_e( 'Headings Color', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="headings_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[headings]' ); ?>" 
					...
					<button type="button" 
						...
						<?php esc_html_e( 'Clear Color', 'alynt-404-sitemap' ); ?>
					</button>
					<p class="description" id="headings_color_desc">
						<?php esc_html_e( 'Color for all heading elements (H1, H2, etc.).', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
					<label for="paragraph_color">
						<?php esc_html_e( 'Paragraph Color', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="paragraph_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[paragraph]' ); ?>" 
					...
					<p class="description" id="paragraph_color_desc">
						<?php esc_html_e( 'Color for paragraph text.', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
					<label for="links_color">
						<?php esc_html_e( 'Links Color', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="links_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[links]' ); ?>" 
					...
					<p class="description" id="links_color_desc">
						<?php esc_html_e( 'Color for all link elements.', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
					<label for="buttons_color">
						<?php esc_html_e( 'Button Background', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="buttons_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[buttons]' ); ?>" 
					...
					<p class="description" id="buttons_color_desc">
						<?php esc_html_e( 'Background color for buttons.', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
					<label for="button_text_color">
						<?php esc_html_e( 'Button Text', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="button_text_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[button_text]' ); ?>" 
					...
					<p class="description" id="button_text_color_desc">
						<?php esc_html_e( 'Text color for buttons.', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
					<label for="search_border_color">
						<?php esc_html_e( 'Search Border', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="search_border_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[search_border]' ); ?>" 
					...
					<p class="description" id="search_border_color_desc">
						<?php esc_html_e( 'Border color for search input.', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
					<label for="search_text_color">
						<?php esc_html_e( 'Search Text', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="search_text_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[search_text]' ); ?>" 
					...
					<p class="description" id="search_text_color_desc">
						<?php esc_html_e( 'Text color for search input.', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
			...
			<tr>
				<th scope="row">
					<label for="search_background_color">
						<?php esc_html_e( 'Search Background', 'alynt-404-sitemap' ); ?>
					</label>
				</th>
				<td>
					<input type="text" 
							id="search_background_color" 
							name="<?php echo esc_attr( ALYNT_404_PREFIX . 'colors[search_background]' ); ?>" 
					...
					<p class="description" id="search_background_color_desc">
						<?php esc_html_e( 'Background color for search input.', 'alynt-404-sitemap' ); ?>
					</p>
				</td>
			</tr>
		</tbody>
...
<div class="alynt-404-settings-section">
	<h2><?php esc_html_e( 'Color Preview', 'alynt-404-sitemap' ); ?></h2>
