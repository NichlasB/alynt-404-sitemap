...
<main id="primary" class="alynt-404-page" role="main">
    <h1><?php echo esc_html($settings['heading'] ?? "Oops! That page can't be found."); ?></h1>
    <p><?php echo esc_html($settings['message'] ?? "Looks like this page took a wrong turn. Let's get you back to where you need to be."); ?></p>
